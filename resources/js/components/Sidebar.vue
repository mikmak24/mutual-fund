<template>
	<nav id="sidebar">
		<div >
			<div  style="background-color: white; width: 300px; height: 90px;">
			...
			<div v-if="isAdmin == 1">
				<h5 style="color: #000000; font-family:verdana;">ADMINISTRATION</h5>
				<br/>
				<ul class="nav flex-column">
					...
					<li class="nav-item">
						<router-link to="/uploadcontribution" class="nav-link active" href="#">
							<h6 style="color: #000000">
								<b-icon icon="file-earmark" variant="dark"></b-icon> Upload Monthly
								Contribution
							</h6>
						</router-link>
					</li>
					<li class="nav-item">
						<router-link to="/employeelist" class="nav-link active" href="#">
							<h6 style="color: #000000">
								<b-icon icon="list" variant="dark"></b-icon> Employee List
							</h6>
						</router-link>
					</li>
					<li class="nav-item">
						<router-link to="/contributionlist" class="nav-link active" href="#">
							<h6 style="color: #000000">
								<b-icon icon="list" variant="dark"></b-icon> Contribution List
							</h6>
						</router-link>
					</li>
